...
<style>
    body {
        ...
        background-color: rgb(186, 164, 214);
        display: flex;
        text-align:center;
    ...
    <div class="container">
        ...
        <form method="GET" action="/fornecedor">
            <select name="cadastro" onchange="if(this.value === 'fornecedor') this.form.submit();">
                ...
                <option value="usuario">Cadastro de Produtos</option>
                <option value="produto">Cadastro de Usuários</option>
...
<body>
    <div class="container">
        <span class="logout-message">LOGOUT REALIZADO</span>
...
<body>
    ...
    if (!rua) {
        conteudo += `
            ...
            <span class="text-danger"> informe a rua</span>`;
    } else {
        conteudo += `
            <input type="text" id="rua" name="rua" value="${rua}">`;
    }

    conteudo += `<label for="numero">NUMERO:</label>`;
    if (!numero) {
        conteudo += `
            <input type="text" id="numero" name="numero" value="">
            <span class="text-danger"> informe o número</span>`;
    } else {
        conteudo += `
    ...
    if (!bairro) {
        conteudo += `
            ...
            <span class="text-danger"> informe o bairro</span>`;
    } else {
        conteudo += `
    ...
    if (!cidade) {
        conteudo += `
            ...
            <span class="text-danger"> informe a cidade</span>`;
    } else {
        conteudo += `
    ...
    if (!estado) {
        conteudo += `
            ...
            <span class="text-danger"> informe o estado</span>`;
    } else {
        conteudo += `
    ...
    if (!email) {
        conteudo += `
            ...
            <span class="text-danger"> informe o email</span>`;
    } else {
        conteudo += `
